...
<body>
    ...
    <div class="breadcumb-area bg-img" style="background-image);">
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                            ...
                            <div class="col-12">
                                <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="500ms">
                                    ...
                                    <div class="blog-post-thumb mb-50">
                                        <img><?php echo "<img src='../admin/file/$hasil[gambar]' width='1500px'>";?></img>
                                    </div>
                                    <!-- Post Title -->
                                    <a href="#" class="post-title"><?php echo $hasil['judul'];?></h4></a>
                                    <!-- Post Excerpt -->
                                    <?php echo substr($hasil['isi'],0,35);?>
									<!-- Read More btn -->
									<?php
									echo "..... <br />[ <a href=pengumuman.php?kode=".$hasil['kode'].">Read More</a>]<hr />";
									?>
											<?php 
											} 
											} ?>
                    ...
                    <div class="academy-pagination-area wow fadeInUp" data-wow-delay="400ms">
                        <nav>
                            <ul class="pagination">
                                <li class="page-item active"><a class="page-link" href="pilihberita.php">01</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
