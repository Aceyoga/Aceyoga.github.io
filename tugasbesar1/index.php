            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="400ms">
                        <div class="testimonial-thumb">
                            <img src="img/bg-img/UNSRI_logo.png" alt="">
                        </div>
                        <div class="testimonial-content">
                            <h5>Fakultas Ilmu Komputer</h5>
                            <p>Berdirinya Fakultas Ilmu Komputer Universitas Sriwijaya atau FASILKOM UNSRI [4] didahului dengan Program Diploma Komputer (PDK) Unsri baru berdiri pertengahan tahun 2003, tepatnya tanggal 5 September 2003.</p>
							<a href="sejarah.php" class="btn academy-btn">See More</a>
                        </div>
                    </div>
                </div>
                <!-- Single Testimonials Area -->
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="500ms">
                        <div class="testimonial-thumb">
                            <img src="img/bg-img/80213.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
                            <h5>Visi Misi Manajemen Informatika</h5>
                            <p>Menjadi program pendidikan vokasional terkemuka dalam pengaplikasian teknologi perangkat lunak bidang perbankan, kesehatan dan industri di Indonesia pada tahun 2025.</h6><br>
							<a href="visimisi.php" class="btn academy-btn">See More</a>
                        </div>
                    </div>
                </div>
            </div>
